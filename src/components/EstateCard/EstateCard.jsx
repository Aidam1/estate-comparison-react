...
const EstateCard = ({ estateData, comparison, order }) => {
    ...
    <div className="estate-card">
      ...
      <div className="estate-card__table">
        ...
        >
          ...
          <span className="estate-card__data">{buildingAreaFormatted} m²</span>
        </div>
        <div
          className={`estate-card__row ${
  ...
  return !estateData ? loading : card;
};
